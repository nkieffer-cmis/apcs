...
{
    Class[] robotClasses = new Class[]{KiefferI.class};
    public MyWorld() throws NoSuchMethodException
    {    
        super(Greenfoot.getRandomNumber(50)+150, Greenfoot.getRandomNumber(50)+50, 5); 
    ...
    public void initLevel1(){
        addRobots(false);
        double blockiness = 0.01;
       // initBoard();
        addBlocks(blockiness);
        addEndZone();
    }
